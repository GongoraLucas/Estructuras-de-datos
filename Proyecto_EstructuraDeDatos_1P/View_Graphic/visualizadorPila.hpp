...
private:
    static const int ANCHO_BLOQUE           = 80;
    static const int ALTO_BLOQUE            = 40;
    static const int MARGEN_X               = 50;
    static const int MARGEN_Y               = 100;
    static const int ESPACIO_ENTRE_BLOQUES  = 5;

    static const int COLOR_BLOQUE   = LIGHTBLUE;
    static const int COLOR_BORDE    = DARKGRAY;
    static const int COLOR_TEXTO    = WHITE;
    static const int COLOR_FONDO    = WHITE;
    static const int COLOR_TEXTO_BG = BLACK;
    static const int COLOR_CIMA     = RED;
    static const int COLOR_POP_BG   = WHITE;
    static const int COLOR_PUSH     = YELLOW;
